...
// 环境变量
const UUID = process.env.UUID || '8817d652-ee1f-4a0d-9ccf-6160e823ded7'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'maincat-teno.hf.space';                   // 域名或ip,留空将自动获取服务器ip
